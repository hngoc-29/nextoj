...
export default function SubmitClient({ problem }) {
    ...
    // Thay đổi handleDrop để dùng cho wrapper
    ...
    return (
        <DragDropWrapper onFileDrop={handleFileDrop}>
            ...
            ">
                ...
                {/* Code editor với drag & drop */}
                <div
                    className="mt-2 border-2 border-dashed border-gray-300 rounded-md transition hover:border-blue-400"
                    style={{ position: 'relative' }}
                    title="Kéo thả file vào đây để tải lên"
                >
                    <div className="absolute left-0 right-0 top-0 bottom-0 flex items-center justify-center pointer-events-none select-none text-gray-400 text-sm z-10" style={{ opacity: 0.2 }}>
